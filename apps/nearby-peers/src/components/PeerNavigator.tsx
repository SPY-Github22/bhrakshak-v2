...
function useDeviceHeading(active: boolean): { heading: number | null; live: boolean } {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
        ...
        <button onClick={onExit} className="md-pressable" style={{ marginLeft: "auto", border: "none", background: "rgba(248,113,113,.14)", color: "#f87171", borderRadius: 999, padding: "5px 12px", fontSize: 11.5, fontWeight: 800, cursor: "pointer" }}>
          ✕ Stop
        </button>
      </div>
